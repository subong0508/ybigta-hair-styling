...
parser.add_argument('--lambda_hair', type=float, default=3)
...
parser.add_argument('--inf_epoch', type=int, default=20)
parser.add_argument('--your_pic', type=str, default='')
parser.add_argument('--celeb_pic', type=str, default='')
